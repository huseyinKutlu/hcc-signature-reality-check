...
**Note:** `training/nnUNetTrainerSwinUNETR.py` is the reference trainer distributed with the U-Mamba repository, included unmodified for completeness; `nnUNetTrainerSwinUNETR_250epochs.py` is our thin subclass that fixes the epoch budget.
